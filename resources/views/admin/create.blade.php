...
@section('page-content')
    <section class="py-20 min-h-screen flex items-center">
        <div class="max-w-screen-lg mx-auto">
            <form class="w-full max-w-sm" method="POST" action="{{ route('competitions.store') }}">
                @csrf
                ...
                <div class="md:flex md:items-center mb-6">
                  ...
                  <div class="md:w-2/3">
                    ...
                    focus:outline-none focus:bg-white focus:border-purple-500" id="name" name="name" type="text" placeholder="Your competition name"
                ...
                <div class="md:flex md:items-center mb-6">
                    ...
                    <div class="md:w-2/3">
                        ...
                        focus:border-purple-500" id="date" name="date" type="text" placeholder="Date"
